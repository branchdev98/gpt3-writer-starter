...
const Home = () => {
  ...
  const callGenerateEndpoint2 = async () => {
    ...
    const response = await fetch("/api/generate2", {
      ...
      body: JSON.stringify({ userInput2 }),
    });
      ...
      <div className="container">
        <div className="header">
          <div className="header-title">
            <h1>Lecture from Expert</h1>
          </div>
          <div className="header-subtitle">
            <h2>Write a message to expert, you will get the lecture </h2>
          </div>
        </div>
        ...
        <div className="header">
          ...
          <div className="header-subtitle">
            <h2>
              Write a unit name in AOE2, you can find the strong and weak vs.{" "}
            </h2>
          </div>
        </div>
        <div className="prompt-container">
